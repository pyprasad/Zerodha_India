"""
generate_report_v12.py
======================
Reads the latest v12 backtest JSON and produces a comprehensive HTML P&L report.
v12 fix: trade times now reflect NSE market hours (09:15 entry, 15:30 exit).

Run:  python generate_report_v12.py
"""
...
v12_files = sorted(Path("reports").glob("v12_backtest_*.json"))
...
VERSION_HISTORY = [
    ...
    ("v11","20 instruments (5 index + 15 stocks) · BB reversion · MACD · Vol breakout",
     "+37.9%", "1.69", "15.9%", "18 yr", "₹10L", "₹3.61Cr", "SUPERSEDED"),
    ("v12",f"Market-hours time fix: 09:15 entry / 15:30 exit (IST) · Paper trading mode",
...
<title>v12 Backtest — P&L Statement</title>
...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  ...
  .v12-badge{{display:inline-block;background:linear-gradient(135deg,rgba(34,197,94,0.2),rgba(6,182,212,0.15));
...
<!-- HEADER -->
<h1>v12 Algorithm — P&amp;L Statement <span class="v12-badge">VERSION 12</span></h1>
<p class="subtitle">
...
<div class="hero" id="hero">
  <div style="color:var(--text2);font-size:.9em;text-transform:uppercase;letter-spacing:.1em;margin-bottom:6px">
    Algorithm v12 · Top-2 Strategies per Instrument · 2008–2026 · Annualised Return
  </div>
...
<footer>
  <p style="margin-bottom:8px">
    <strong style="color:var(--green)">Algorithm v12</strong> &nbsp;·&nbsp;
...
out_file = Path(f"reports/v12_PnL_Statement_{ts}.html")
