"""
generate_report_v11.py
======================
Reads the latest v11 backtest JSON and produces a comprehensive HTML P&L report
styled identically to the v6 Kite report — dark theme, Chart.js charts, full tables.

Run:  python generate_report_v11.py
"""
...
VERSION_HISTORY = [
    ...
    ("v11",f"20 instruments (5 index + 15 stocks) · BB reversion · MACD · Vol breakout\n"
           f"Per-instrument optimal strategy from 180-combination grid",
...
<title>v11 Backtest — P&L Statement</title>
...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  ...
  .v11-badge{{display:inline-block;background:linear-gradient(135deg,rgba(34,197,94,0.2),rgba(6,182,212,0.15));
...
<!-- HEADER -->
<h1>v11 Algorithm — P&amp;L Statement <span class="v11-badge">VERSION 11</span></h1>
<p class="subtitle">
...
<div class="success">
  <h4>✅ Key Breakthrough: Bollinger Band Reversion wins on 19/20 instruments</h4>
  <p>180-combination discovery grid (9 strategies × 20 instruments) found that BB%B reversion
  dramatically outperforms Williams%R on every instrument. Expanding universe from 5 indices to
  20 instruments (adding 15 liquid NSE stock futures) and switching to BB reversion lifted CAGR
  from +28.8% (v10) → <strong>+37.9%</strong>, Sharpe from 0.75 → <strong>1.69</strong>, and
  MaxDD from 32.9% → <strong>15.9%</strong>.</p>
</div>
...
<div class="hero" id="hero">
  <div style="color:var(--text2);font-size:.9em;text-transform:uppercase;letter-spacing:.1em;margin-bottom:6px">
    Algorithm v11 · Top-2 Strategies per Instrument · 2008–2026 · Annualised Return
  </div>
...
<div class="card section" id="trades">
  ...
  <table>
    <thead><tr>
      <th>Exit Date</th><th>Instrument</th><th>Dir</th>
...
<footer>
  <p style="margin-bottom:8px">
    <strong style="color:var(--green)">Algorithm v11</strong> &nbsp;·&nbsp;
...
out_file = Path(f"reports/v11_PnL_Statement_{ts}.html")
